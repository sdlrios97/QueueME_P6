...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Resources/CSS/DefaultPage_style.css">
...
<body>
    <header>
        ...
        <div class="small-text-box">
            ...
            <a class="btn btn-sign_up" href="Web/SignUp.html">Sign Up</a>
            <a class="btn btn-login" href="Web/Login.aspx">Login In</a>
        </div>
    </header>
</body>
