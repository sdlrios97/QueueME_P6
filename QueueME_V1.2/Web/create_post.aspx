				...
				<form id="frm1" action="post.aspx" method="post">
					...
					<div  class="row">
						<div class="col-md-4 col-6 bottom_leftbox">
							...
							<textarea id="desc" name="desc" rows="10" cols="35" maxlength="256" style="resize: none;"></textarea> <br /><br />&nbsp
						</div>
						<div class="col-md-4 col-6 boxbottom">
							...
							<input type="checkbox" id="tag_racing" name="tags" /> Racing<br />&nbsp
						...
						<div class="col-md-4 col-6 bottom_rightbox">
							...
							<img id="preview" src="../resources/CSS/img/error.png" height="200" alt="Image preview...">
						</div>
					</div>
